...
Since no other arguments were supplied, in this case data were generated using the default "agnostic" method. Some Use of the `stub` object created with the "empirical" method can construct more realistic data:
